        ...
        <div>
            ...
            <div className="row flex-row" style={{ marginTop: '15%' }} >
                ...
                <div className="col-md-6">
                    ...
                    <button style={{ fontFamily: 'roboto', marginTop: '3%', marginBottom: '5%', textAlign: "center" }} className="btn btn-primary float-left">Saiba mais</button>
                </div>
            ...
            <div className="row flex-row-reverse" style={{ marginTop: '15%' }} >
                ...
                <div className="col-md-6">
                    ...
                    <p style={{ fontFamily: 'roboto', display: 'none' }}>Uma coisa que escuto muito de pacientes de Fisioterapia convencional, amigos e parentes é “mas o que é a fisioterapia pélvica?”. Por ser uma área ainda em crescimento, poucas são as pessoas que conhecem essa especialidade dentro da fisioterapia.
                    .
                    ...
                    <button style={{ fontFamily: 'roboto', marginTop: '3%', marginBottom: '5%', textAlign: "center" }} className="btn btn-primary float-right">Saiba mais</button>
                </div>
            ...
            <div className="row flex-row" style={{ marginTop: '15%' }} >
                ...
                <div className="col-md-6">
                    ...
                    <button style={{ fontFamily: 'roboto', marginTop: '5%', marginBottom: '3%', textAlign: "center" }} className="btn btn-primary float-left">Saiba mais</button>
                </div>
            </div>
        </div>
    )
